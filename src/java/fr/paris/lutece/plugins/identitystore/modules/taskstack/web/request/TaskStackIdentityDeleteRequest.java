...
public class TaskStackIdentityDeleteRequest extends AbstractIdentityStoreAppCodeRequest
{

    ClientTaskRightDeleteRequest _clientTaskRequest;
    ...
    public TaskStackIdentityDeleteRequest(ClientTaskRightDeleteRequest clientTaskRequest, String strClientCode,
    ...
    protected ResponseDto doSpecificRequest() throws IdentityStoreException
    {
        ...
        ClientTaskRightService.instance().delete( _clientTaskRequest, _author, _strClientCode );
